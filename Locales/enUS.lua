...
L["VT: Cannot add enemy - you are trying to add too many enemies of the same kind"] = "VT: Cannot add enemy - you are trying to add too many enemies of the same kind"
L["Clear all Markers"] = "Clear all Markers"
L["Okay"] = "Okay"
L["Warning"] = "Warning"
L["assignmentWarning"] = "VT will NOT automatically set target markers on enemies in the game world."
...
L["chatNoninteractiveWarning"] =
  "Chat frame is currently set to noninteractive, you will not be able to click on VT routes."
...
L["VTGuideNote"] = "VTGuide is not affiliated with Mythic Dungeon Tools and is a seperate AddOn."
L["encounteredErrors"] = "VT has encountered errors.\nClick to view them."
...
L["errorLabel1"] = "VT has encountered errors."
L["errorLabel2"] =
  "Please update VT to the latest version and visit either GitHub or Discord and report the error message below."
...
L["conflictPrompt"] =
  "VT has detected that you have certain AddOns installed that are conflicting with VT.\n\nPlease remove or update the following AddOns:\n\n"
L["Middle-click to disable Minimap Button"] = "Middle-click to disable Minimap Button"
L["VT: Use /VT minimap to show the minimap icon again"] = "VT: Use /VT minimap to show the minimap icon again"
...
L["ExportStringShareExternalWebsite"] = "You can share VT exports on external websites"
...
L["Click the fullscreen button for a maximized view of VT."] =
  "Click the fullscreen button for a maximized view of VT."
...
L["ConnectedTip"] = "Group connections in VT do not reflect if NPCs are linked together in the game world."
...
L["Drag the bottom right edge to resize VT."] = "Drag the bottom right edge to resize VT."
...
L["MDI Mode"] = "MDI Mode"
L["VT: Error importing preset"] = "VT: Error importing route"
L["VT: Spells for %s:"] = "VT: Spells for %s:"
...
L["noDungeonData2"] = "Create your own data via /VT devmode"
...
L["receiveErrorUpdate"] =
  "VT could not properly receive a route, please make sure sender %s has the latest version of VT installed!"
...
L["Use /VT reset to restore the default position and scale of VT."] =
  "Use '/VT reset' to restore the default position and scale of VT."
...
L["You are using VT. You rock!"] = "You are using VT. You rock!"
L[
...
--@localization(locale="enUS", format="lua_additive_table", namespace="VT", handle-subnamespaces="none")@
