local Type, Version = "VTSpellButton", 1
  ...
  ["Initialize"] = function(self)
    ...
    function self.callbacks.OnKeyDown(_, key)
      ...
      if db.devMode then
        ...
        local enemyIdx = VT:GetEnemyInfoEnemyIdx()
        ...
        if key == "I" then
          ...
          VT:UpdateEnemyInfoFrame(enemyIdx)
        end
        if key == "M" then
...
local function Constructor()
  local name = "VTSpellButton"..AceGUI:GetNextWidgetNum(Type)
